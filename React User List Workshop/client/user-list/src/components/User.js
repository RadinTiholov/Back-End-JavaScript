export const User = (props) => {
    return (
        <tr>
        <td>
          <img src={props.imageUrl} alt="Profile pic" className="image" />
        </td>
        ...
        <td className="actions">
          <button className="btn edit-btn" title="Edit">
            <svg aria-hidden="true" focusable="false" data-prefix="fas" onClick = {() => props.editClickHandler(props._id)} data-icon="pen-to-square" className="svg-inline--fa fa-pen-to-square" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 532 512">
          ...
          <button className="btn delete-btn" title="Delete">
            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="trash" onClick={() => props.deleteClickHandler(props._id)} className="svg-inline--fa fa-trash" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 498 512">
          ...
          <button className="btn info-btn" title="Info" onClick={() => props.detailsClickHandler(props._id)}>
